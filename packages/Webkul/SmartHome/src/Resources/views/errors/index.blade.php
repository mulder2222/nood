		...
		<div class="grid h-[100vh] w-full">
            ...
            <div class="absolute left-1/2 top-[74%] mt-10 -translate-x-1/2 -translate-y-1/2 text-center max-868:w-full max-md:top-[60%]">
                ...
                <a
                    ...
                    class="m-auto mt-8 block w-max cursor-pointer rounded-[45px] bg-sentraRed px-10 py-4 text-center text-base font-medium text-white max-sm:mb-10 max-sm:px-6 max-sm:text-sm"
                >
