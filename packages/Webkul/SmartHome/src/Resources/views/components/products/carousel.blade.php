...
@pushOnce('scripts')
    ...
    >
        <div
            class="container lg:px-0 mt-20 max-lg:px-8 max-md:mt-8 max-sm:mt-7 max-sm:!px-4"
        ...
        >
            ...
            <div
                ref="swiperContainer"
                class="flex gap-5 pb-2.5 [&>*]:flex-[0] mt-10 overflow-auto scroll-smooth scrollbar-hide max-md:gap-7 max-md:mt-5 max-sm:gap-4 max-md:pb-0 max-md:whitespace-nowrap"
            >
                <x-shop::products.card
                    class="min-w-[291px] max-md:min-w-56 max-sm:min-w-[192px]"
