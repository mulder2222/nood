...
@pushOnce('scripts')
    ...
    >
        <!-- Grid Card -->
        <div
            class="border-2 border-gray-200 p-2 1180:transtion-all group w-full rounded-md 1180:relative 1180:grid 1180:content-start 1180:overflow-hidden 1180:duration-300 1180:hover:shadow-[0_5px_10px_rgba(0,0,0,0.1)]"
            v-if="mode != 'list'"
        >
            <div class="relative max-h-[300px] max-w-[291px] overflow-hidden max-md:max-h-60 max-md:max-w-full max-md:rounded-lg max-sm:max-h-[200px] max-sm:max-w-full">
                ...
                <div class="action-items bg-black">
                    ...
                    <!-- Product New Badge -->
                    <p
                        class="absolute top-1.5 inline-block bg-sentraRed px-2.5 text-sm text-white max-sm:px-2 max-sm:py-0.5 max-sm:text-xs ltr:left-1.5 max-sm:ltr:left-0 rtl:right-1.5 max-sm:rtl:right-0"
            ...
            <div class="grid max-w-[291px] content-start gap-2.5 bg-white p-2.5 max-md:relative max-md:mt-0 max-md:translate-y-0 max-md:gap-0 max-md:px-0 max-md:py-1.5 max-sm:min-w-[157px] max-sm:max-w-[157px]">

                {!! view_render_event('bagisto.shop.components.products.card.name.before') !!}

                <p class="break-all text-base font-medium max-md:mb-1.5  max-md:whitespace-break-spaces max-md:leading-6 max-sm:max-w-[165px] max-sm:text-sm max-sm:leading-4 line-clamp-2 overflow-ellipsis">
                    @{{ product.name }}
                </p>
                ...
                <div
                    class="flex items-center gap-1 text-lg font-semibold max-sm:text-sm max-sm:leading-6 overflow-hidden"
                ...
                <div class="flex items-center gap-2.5 text-sm font-semibold max-sm:text-sm max-sm:leading-6 mt-2">
                    <!-- In Stock -->
                    <div class="text-green-500 font-bold" v-if="product.is_saleable">
                        <i class="icon-tick filled" style="background-color: #22c55e; color: #fff; border-radius: 9999px; padding: 2px;"></i>
                        Op Voorraad
                    </div>
                    <!-- Out of Stock -->
                    <div class="text-red-500 font-bold" v-else>
                        <i class="icon-cancel filled" style="background-color: #ef4444; color: #fff; border-radius: 9999px; padding: 2px;"></i>
                        Niet op Voorraad
                    </div>
                </div>
            </div>
