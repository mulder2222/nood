...
<div class="flex container mx-auto p-4 space-x-4 justify-between border border-b border-l-0 border-r-0 border-t-0 px-[0px] max-1180:px-8">
    <!--
    ...
    <div class="flex items-center gap-x-10 max-[1180px]:gap-x-5">
        ...
        <!-- Categories moved to navigation section -->

        {!! view_render_event('bagisto.shop.components.layouts.header.desktop.bottom.category.after') !!}
    </div>

    <!-- Right Nagivation Section -->
    <div class="flex w-3/4 items-center gap-x-40 max-[1100px]:gap-x-6 max-lg:gap-x-40">
        ...
        <div class="relative w-full">
            ...
            >
                ...
                <input
                    ...
                    name="query"
                    value="{{ request('query') }}"
                    class="block w-full rounded-lg border border-transparent bg-zinc-100 px-11 py-3 font-medium text-gray-900 transition-all hover:border-gray-400 focus:border-gray-400"
...
@pushOnce('scripts')
    ...
    >
        ...
        >
            <div
                class="text-sm group relative flex items-center border-b-4 border-transparent hover:border-b-4 hover:border-navyBlue"
                v-for="category in categories"
            >
                <span>
                    <a
                        :href="category.url"
                        class="inline-block px-2 text-black"
                    >
                        @{{ category.name }}
                    </a>
                </span>
