...
<div class="flex flex-wrap gap-4 px-4 pb-4 pt-6 shadow-sm lg:hidden">
                            ...
                            <x-slot:content>
                                ...
                                <div class="mt-6 flex gap-4">
                                    ...
                                    <a
                                        ...
                                        class="m-0 mx-auto block w-max cursor-pointer rounded-2xl bg-sentraRed px-7 py-4 text-center text-base font-medium text-white ltr:ml-0 rtl:mr-0"
                                    >
    ...
    <form action="{{ route('shop.search.index') }}" class="flex w-full items-center">
        ...
        <div class="relative w-full">
            ...
            <input
                type="text"
                class="block w-full rounded-xl border border-['#E3E3E3'] px-11 py-3.5 text-sm font-medium text-gray-900 max-md:rounded-lg max-md:px-10 max-md:py-2 max-md:font-normal max-sm:text-base"
                name="query"
                value="{{ request('query') }}"
                        ...
                        >
                            ...
                            <div v-if="category.children && category.children.length" >
                                ...
                                >
                                    ...
                                    >
                                        <a :href="secondLevelCategory.url" class="text-sm font-normal text-black">
