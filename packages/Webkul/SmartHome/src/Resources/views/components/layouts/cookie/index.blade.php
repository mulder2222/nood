    ...
    >
        {!! view_render_event('bagisto.shop.settings.gdpr.modal.cookie.before') !!}
            ...
            @if (core()->getConfigData('general.gdpr.cookie.enabled'))
                <div
                    class="js-cookie-consent fixed z-[999] mx-4 box-border hidden min-h-5 overflow-hidden rounded bg-white p-7 border border-gray-300"
                    :class="getPositionClasses(position)"
                >
                    <div class="cookieTitle">
                        <span class="mb-1.5 block font-sans text-xl leading-5 text-black">
                            {{ core()->getConfigData('general.gdpr.cookie.static_block_identifier') }}
                        </span>
                    </div>

                    <div class="cookieDesc cookie-consent__message">
                        <p class="mt-2.5 block font-sans text-sm leading-5 text-black">
                    ...
                    <div class="cookieButton">
                        <div class="mt-2.5 flex gap-2">
                            <a
                                class="box-border inline-block w-full cursor-pointer rounded bg-sentraRed px-6 py-4 text-center font-sans text-sm font-bold text-white transition-colors duration-300 ease-in-out hover:bg-blue-400 hover:text-white"
                                @click="createCookie()"
                            >
                        ...
                        <a
                            class="mt-2.5 box-border inline-block w-full cursor-pointer rounded bg-sentraRed px-6 py-4 text-center font-sans text-sm font-bold text-white transition-colors duration-300 ease-in-out hover:bg-blue-400 hover:text-white"
