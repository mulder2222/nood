                            ...
                            <template v-for="method in methods">
                                ...
                                >
                                    ...
                                    <label
                                        ...
                                        :for="rate.method"
                                    >
                                        <!-- Dynamic icon based on shipping method -->
                                        <span
                                            :class="{
                                                'icon-flate-rate': rate.carrier === 'flatrate',
                                                'icon-Free-Shipping': rate.carrier === 'freeabovethreshold',
                                                'icon-location': rate.carrier === 'free'
                                            }"
                                            class="text-6xl text-navyBlue max-sm:text-5xl"
                                        ></span>
